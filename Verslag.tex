...
\end{align*}
Dit geeft een partiële differentiaal vergelijking. \(f\) representeert de file toevoer en is dus van twee dingen afhankelijk: 
...
\end{align}
Dit geeft een basis om het probleem te modelleren.
